    ...
    try {
      if (isLogin) {
        ...
        if (!userCredential.user.emailVerified) {
          ...
          setMessage("❌ Your email is not verified. Please check your inbox and verify before logging in.");
          return;
        }
        ...
        setMessage("✅ Registered! Please check your email to verify before logging in.");
        await auth.signOut(); // sign out newly registered user
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: "13px", color: "#555", marginTop: "10px", textAlign: "center" }}>
